...
%You don't want more indexes than actual data
indices=indices(1:t,:);

%You also don't want indexes to go beyond the last data point
indices(indices>t) = indices(indices>t)-t;

%select the data on the base of the bootstrapped indexes
bsdata=data(indices);
